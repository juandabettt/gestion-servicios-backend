        ...
        return AiAnalysisPortResult.builder()
                ...
                .recomendaciones(List.of(
                        AiAnalysisPortResult.Recommendation.builder()
                                ...
                                .descripcion(
                                        "El calentador de agua podría estar fallando. Una revisión técnica puede reducir el consumo en un 20%.")
                        ...
                        AiAnalysisPortResult.Recommendation.builder()
                                ...
                                .descripcion(
                                        "Usa electrodomésticos de alto consumo después de las 10pm para aprovechar la tarifa reducida.")
                ...
                .prediccionProximaFactura(AiAnalysisPortResult.ConsumptionPrediction.builder()
                        ...
                        .build())
                .resumenEjecutivo(
                        "Tu consumo de energía se encuentra 15% por encima del promedio de hogares similares en tu ciudad. "
                                +
